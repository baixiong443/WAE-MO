    ...
    public class WindowController
    {
        ...
        { 
            get
            {
                ...
                {
                    _historyWindow.RefreshLanguage(MainMenu.IsChinese);
                }
        ...
        private MegamapGenerationOptionsWindow _megamapGenerationOptionsWindow;
        
        public MegamapGenerationOptionsWindow MegamapGenerationOptionsWindow 
        { 
            get
            {
                if (_megamapGenerationOptionsWindow != null)
                {
                    _megamapGenerationOptionsWindow.RefreshLanguage(MainMenu.IsChinese);
                }
                return _megamapGenerationOptionsWindow;
            }
            private set
            {
                _megamapGenerationOptionsWindow = value;
            }
        }

        private CopiedEntryTypesWindow _copiedEntryTypesWindow;
        
        public CopiedEntryTypesWindow CopiedEntryTypesWindow 
        {
            get 
            {
                if (_copiedEntryTypesWindow != null)
                {
                    _copiedEntryTypesWindow.RefreshLanguage(MainMenu.IsChinese);
                }
                return _copiedEntryTypesWindow;
            }
            private set
            {
                _copiedEntryTypesWindow = value;
            }
        }
        ...
        public void Initialize(IWindowParentControl windowParentControl, Map map, EditorState editorState, ICursorActionTarget cursorActionTarget)
        {
            ...
            _copiedEntryTypesWindow = new CopiedEntryTypesWindow(windowParentControl.WindowManager);
            ...
            _historyWindow = new HistoryWindow(windowParentControl.WindowManager, cursorActionTarget.MutationManager);
