...
namespace TSMapEditor.CCEngine
{
    ...
    public class ScriptAction
    {
        ...
        public string ChineseName { get; set; } = "未知动作";
        public string Description { get; set; } = "No description";
        public string ChineseDescription { get; set; } = "无描述";
        ...
        public void ReadIniSection(IniFile iniFile, string sectionName)
        {
            ...
            ChineseName = iniSection.GetStringValue(nameof(ChineseName), Name);
            Description = iniSection.GetStringValue(nameof(Description), Description);
            ChineseDescription = iniSection.GetStringValue(nameof(ChineseDescription), Description);
