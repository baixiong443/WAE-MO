...
namespace TSMapEditor.CCEngine
{
    ...
    public class TriggerActionType : IHintable
    {
        ...
        {
            if (UI.MainMenu.IsChinese && !string.IsNullOrEmpty(ChineseName))
                return ChineseName;
            return Name;
        }
        ...
        {
            if (UI.MainMenu.IsChinese && !string.IsNullOrEmpty(ChineseDescription))
