...
namespace TSMapEditor.UI.CursorActions
{
    ...
    public class ManageBaseNodesCursorAction : CursorAction
    {
        ...
        public override string GetName() => TSMapEditor.UI.MainMenu.IsChinese ? "管理基地节点" : "Manage Base Nodes";
        ...
        public override void DrawPreview(Point2D cellCoords, Point2D cameraTopLeftPoint)
        {
            ...
            {
                text = "放置操作：" + Environment.NewLine +
                    "点击建筑物放置一个基地节点。" + Environment.NewLine +
                    "按住SHIFT键点击可同时删除源建筑。" + Environment.NewLine +
                    "按住CTRL键点击可删除基地节点。" + Environment.NewLine + Environment.NewLine +
                    "按住M键拖动基地节点可移动它。" + Environment.NewLine + Environment.NewLine +
                    "排序操作：" + Environment.NewLine +
                    "悬停在基地节点上按E键可提前建造顺序。" + Environment.NewLine +
                    "悬停在基地节点上按D键可延后建造顺序。";
            }
            else
            {
                text = "Placement actions:" + Environment.NewLine +
