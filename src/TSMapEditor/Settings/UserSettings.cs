    ...
    public class UserSettings
    {
        ...
        public UserSettings()
        {
            ...
            settings = new IINILoadable[]
            {
                ...
                MentalOmegaGameDirectory,
                YurisRevengeGameDirectory,

                TextEditorPath,

                Language,
                
                SelectNewlyCreatedHouse
            };
        ...
        public StringSetting GameVersion = new StringSetting(General, "GameVersion", "MentalOmegaClient");

        public StringSetting MentalOmegaGameDirectory = new StringSetting(General, "MentalOmegaGameDirectory", string.Empty);
        public StringSetting YurisRevengeGameDirectory = new StringSetting(General, "YurisRevengeGameDirectory", string.Empty);

        public StringSetting TextEditorPath = new StringSetting(General, "TextEditorPath", string.Empty);

        public StringSetting Language = new StringSetting(General, "Language", "zh");

        public BoolSetting SelectNewlyCreatedHouse = new BoolSetting(General, "SelectNewlyCreatedHouse", true);
