...
namespace TSMapEditor.Rendering
{
    public class GameClass : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            // 初始化翻译管理器
            IniTranslationManager.Initialize();
            TechnoNameManager.Initialize();
            CategoryNameManager.Initialize();
            OverlayNameManager.Initialize();
            TerrainObjectNameManager.Initialize();
            TileSetNameManager.Initialize();
